...
const products = [
  { name: 'Items', href: '/items', icon: BsCupHot  },
  { name: 'T Shirt', href: '#', icon: IoShirtOutline },
  { name: 'Toy', href: '#', icon: LuDessert },
  { name: 'Integrations', href: '#', icon: PiFan  },
  { name: 'Book', href: '#', icon: IoBookOutline },
  { name: 'Noodles', href: '#', icon: GiNoodles },
  { name: 'Rice', href: '#', icon: FaBowlRice },
]
